...
public class Exam_File {
	...
	public static void main(String[] args) throws IOException {
		...
		File folderMake = new File("src/org/atheNA/day15/file/sample");
		if(!folderMake.exists()) {
			folderMake.createNewFile();
		...
		File fileMake = new File("src/org/atheNA/day15/file/sample.txt");
		if(!fileMake.exists()) {
